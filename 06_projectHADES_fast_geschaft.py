...
# und bei 5 quantile gibt es eine ähnliche ID aus bei 4 q aber keine --> macht das Sinn??
...
display_liste = ['middle Hight', 'slope', 'C', 'D', 'E']
...
db_list = ['mH_04', 'N20slp8_12', 'Banana', 'Icecream', 'Bananasplit']
